...
$sql = "SELECT post  FROM `reply` WHERE `get` LIKE '%$word%'";
        // $sql = "SELECT post FROM reply";
        ...
        if ($result) {
            ...
            return ResponsePassive::text($request['fromusername'], $request['tousername'], '我还不知道怎么回答你哦');
        }
    }
